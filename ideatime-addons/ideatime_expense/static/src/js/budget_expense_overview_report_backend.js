...
var BudgetExpenseOverviewReport = stock_report_generic.extend({
    events: {
    ...
    get_html: function() {
        ...
        return this._rpc({
                model: 'budget.expense.overview.report',
                method: 'get_html',
                args: args,
...
core.action_registry.add('budget_expense_overview_report', BudgetExpenseOverviewReport);
export default BudgetExpenseOverviewReport;
