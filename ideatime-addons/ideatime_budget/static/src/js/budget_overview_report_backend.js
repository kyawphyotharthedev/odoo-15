...
var BudgetOverviewReport = stock_report_generic.extend({
    events: {
...
core.action_registry.add('budget_overview_report', BudgetOverviewReport);
export default BudgetOverviewReport;
