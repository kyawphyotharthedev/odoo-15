    ...
    def process_data(self, data):
        if data:
            ...
            for account in account_ids:
                ...
                if account.code == '962400':
                    print(init_blns['initial_balance'] ,"==========================",bln)
                ...
                # if account.code in ['252040','962400']:
                #     print(init_blns,"===========int deb=======",init_blns['initial_debit'],'================',init_blns['initial_credit'],"--------------------",op)
                ...
                if data.get('display_accounts') == 'balance_not_zero':
                    ...
                    if end_blns: # debit or credit exist
                        ...
                        # print("=====================elif bln case",deb,"===========",account.code)
                        continue
                    else:
                        # print("=====================else case")
                    ...
                    total_cre += cre
                    total_bln += bln
                # print(total_cre,"----------",total_deb,"-----------",total_bln)
            ...
            subtotal = {'SUBTOTAL': {
                ...
                'company_currency_id': company_currency_id.id}}
            # print(subtotal,"________________________________-this is subtotal")
