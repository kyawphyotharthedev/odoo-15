odoo.define('ideatime_product_configurator.ProductConfiguratorMixin', function (require) {
'use strict';
...
var ProductConfiguratorMixin = {
    ...
    _updateProductImage: function ($productContainer, productId, productTemplateId) {
        ...
        var imageUrl = '/web/image/{0}/{1}/' + (this._productImageField ? this._productImageField : 'image_512');
